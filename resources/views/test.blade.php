...
<div class="form-group">
  ...
  <span class="input-group-addon"> <div class="dropdown">
...
<input class="form-control" ng-keyup="format_phone()" ng-maxlength=16 ng-minlength=12 ng-pattern="/^([\+][0-9]{2}|[0-9]{4})[\s]?[0-9]{3}[\s]?[0-9]{3}/" type="text" id="phone_number_field" name="phone_number" placeholder="Phone number" ng-model="phone_number" ng-style="myStyle">                       
</div>
<span id="phone_number_error" ng-show="SMS_Form.phone_number.$invalid && SMS_Form.phone_number.$touched">
        <i class="glyphicon glyphicon-remove-sign"></i>Inappropriate phone number!</span>
  </div>
</div>
<div class="form-group">
...
<span id="message_length_field" ng-if="message">@{{message.length+"/160"}}</span>
  ...
  <div class="col-md-4">
    <button type="submit" class="btn btn-warning" ng-disabled="SMS_Form.phone_number.$invalid">Send <span class="glyphicon glyphicon-send"></span></button>
  </div>
</div>
</fieldset>
		</form>
...
<div class="container">
		 ...
		 @foreach($SMSs as $sms)
			<div class="row">
				...
				<div class="col-sm-3">
					 <a href="localhost/index.php/delete/{{$sms->id}}"><img src="../../../public/images/trash.png" width="30" height="30" title="Delete" alt="Delete">
				</div>
			</div>
			@endforeach
</div>
